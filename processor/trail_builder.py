...
def filtrar_editais(respostas: dict, editais: list[EditalEstruturado]) -> list[EditalEstruturado]:
    ...
    for edital in editais:
        # Nota: NAO filtramos por data de encerramento aqui.
        # Editais vencidos sao exibidos com status "Encerrado" no frontend
        # (via StatusBadge / dias_restantes), permitindo que o usuario veja
        # oportunidades passadas e fique atento a novos ciclos.
